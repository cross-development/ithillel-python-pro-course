...
def main(urls: List[str]) -> None:
    ...
    logger.info("Starting multithreading requests...")

    threads = [threading.Thread(target=thread_request, args=(url,)) for url in mult_valid_urls]
    ...
    logger.info(f"Total time (multithreading): {elapsed_time:.2f} seconds")

class Proxy:
    """
    A Proxy class that intercepts method calls to another object, logging the method name and arguments.
    """
    ...
    def __getattr__(self, name: str) -> callable:
        """
        Intercepts method calls and logs the method name and arguments before calling the method on the original object.

        Args:
            name (str): The name of the method being called.

        Returns:
            callable: A wrapper function that logs the method call and arguments, then calls the original method.
        """

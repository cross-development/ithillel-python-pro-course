...
class Player:
    ...
    def get_resource(self, resource: GameResource) -> int:
        ...
        Returns:
            int: The amount of the resource the player has, or 0 if the player doesn't have the resource.
        """
    ...
    def check_all_resources(self, required_resources: Dict[GameResource, int]) -> None:
        ...
        Args:
            required_resources (Dict[GameResource, int]): A dictionary of the resources to check and their amounts.
    ...
    def spend_resources(self, required_resources: Dict[GameResource, int]) -> None:
        """
        Spends resources from the player's resources. All resources are spent only if the player has enough of each resource.

        Args:
            required_resources (Dict[GameResource, int]): A dictionary of the resources to spend and their amounts.
